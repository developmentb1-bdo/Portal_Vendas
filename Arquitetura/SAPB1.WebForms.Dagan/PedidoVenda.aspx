<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="PedidoVenda.aspx.cs" Inherits="SAPB1.WebForms.Dagan.PedidoVenda" %>
                ...
                <asp:GridView
                    ...
                    OnRowDataBound="grdPedidoVenda_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Parceiro de Negócio" Visible="false">
                                <ItemTemplate>
                                    <asp:Label
                                        runat="server"
                            ...
                            <asp:TemplateField HeaderText="Data de Lançamento" Visible="false">
                                <ItemTemplate>
                                    <asp:Label
                                        runat="server"
