...
namespace SAPB1.WebForms.Abt
{
    public partial class CadastroProduto : System.Web.UI.Page
    {
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            string retorno = estruturaItemBLL.GerarArquivoCadastroProdutoEstrutura(caminhoCompleto);
            ...
            if (retorno.Equals(""))
            {
                try
                {
                    ...
                    Response.AppendHeader("Content-Disposition", "attachment; filename=CadastroProduto.txt");
