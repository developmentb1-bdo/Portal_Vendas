<%@ Page
    ...
    Language="C#" MasterPageFile="~/SapB1Master.Master"
    AutoEventWireup="true" CodeBehind="PedidoVenda_Action.aspx.cs"
    Inherits="SAPB1.WebForm.PedidoVenda_Action" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="box-body" style="display: block">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Filial:</label>
                        <asp:DropDownList ID="cmbFilial" runat="server" CssClass="form-control" ClientIDMode="Static"></asp:DropDownList>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box-body" style="display: block">
            ...
            <asp:Panel
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Quantidade de Metros:</label>
                            <asp:TextBox
                                runat="server"
                                ID="txtQtdMetrosItem"
                                CssClass="form-control"
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Quantidade Venda(KG):</label>
                            <asp:TextBox
                                runat="server"
                                ID="txtPesoEstoqueItem"
                                CssClass="form-control"
                                onkeypress="return isNumberKey(event)"
                                MaxLength="50">
                            </asp:TextBox>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Núm.Pedido de Compra:</label>
                            <asp:TextBox
                                runat="server"
                                ID="txtNumPedidoCompra"
                                CssClass="form-control"
                                MaxLength="50">
                            </asp:TextBox>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>It.Ped. Ordem de Compra:</label>
                            <asp:TextBox
                                runat="server"
                                ID="txtItemPedidoCompra"
                                onkeypress="return isNumberKey(event)"
                                CssClass="form-control"
                                MaxLength="50">
                            </asp:TextBox>
            ...
            <div class="table-responsive">
                <table id="tblInsert" class="table table-bordered table-striped dataTable">
                    <tbody>
                        <tr>
                            ...
                            <th>Núm.Pedido de Compra
                            </th>
                            <th>It.Ped. Ordem de Compra
                            </th>
                            <th>#
                            </th>
                        </tr>
                ...
                <asp:GridView
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descrição Auxiliar">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("DescricaoAuxiliar").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Data Entrega">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#(String.IsNullOrEmpty(Eval("DataEntrega").ToString())) ? "" : Eval("DataEntrega", "{0:d}") %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Comprimento">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("Comprimento").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Norma">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("Norma").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Qtd Barra/PC">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("QtdBarra").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Quantidade de Metros">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("QtdMetro").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Peso Estoque">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("Peso").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="UM">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblDeliveryGrid"
                                    Text='<%#Eval("UnidadeMedida").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Núm.Pedido de Compra">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblTotalGrid"
                                    Text='<%# Eval("NumeroPedidoCompra").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="It.Ped. Ordem de Compra">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblTotalGrid"
                                    Text='<%# Eval("ItemPedidoCompra").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            <h3 class="box-title">Dados da Transportadora
            </h3>
            <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            </div>
    ...
    <div class="box box-warning">
        <div class="box-header with-border">
            <h3 class="box-title">Informações Gerais
            </h3>
            <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
            </div>
    ...
    <script type="text/javascript">
        ...
        $("#<%= txtDataEntregaItem.ClientID %>").inputmask("dd/mm/yyyy", { "placeholder": "dd/mm/yyyy" });
        ...
        $(document).ready(function () {
            ...
            //QtdPecas
            $("#<%=txtQtdBarraItem.ClientID%>").change(function () {
                var codigoFilial = $("#<%=ddlFilial.ClientID%>").val();
                var comprimento = $("#<%= txtComprimentoItem.ClientID %>").val();
                var qtdbarra = $("#<%= txtQtdBarraItem.ClientID %>").val();
                var nrolote = $("#<%= txtNLoteItem.ClientID %>").val();
                ...
                $.ajax({
                    url: "PedidoVenda_Action.aspx/RetornarDadosItemQuantidade", //URL da página com o WebMethod 
                    data: "{filial:'" + codigoFilial + "',codItem:'" + codItem + "',Comprimento:'" + comprimento + "',Pecas:'" + qtdbarra + "',Lote:'" + nrolote + "'}", //Enviar os parâmetros
                    type: "POST", //Tipo do envio (POST ou GET)
                    dataType: "json", //Tipo retorno dos dados
                    contentType: "application/json; charset=utf-8", //Conteúdo do retorno (header)
                    ...
                    success: function (retorno) {
                        if (retorno.d.length > 0) {
                            ...
                            var metro = parseFloat(retorno.d[0].QtdMetro).toFixed(2);
                            var peso = parseFloat(retorno.d[0].Peso).toFixed(0);

                            $("#<%= txtQtdMetrosItem.ClientID%>").val(metro.toString().replace(".", ","));
                            $("#<%= txtPesoEstoqueItem.ClientID%>").val(peso.toString().replace(".", ","));
                            $("#<%= txtQtdItem.ClientID%>").val(peso.toString().replace(".", ","));
                        }
                    },
                    //Função de erro do retorno dos dados feita pelo ajax
                    error: function (req, status, error) {
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#<%= txtCodigoItem.ClientID %>").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    var codigoFilial = $("#<%=cmbFilial.ClientID%>").val();

                    $.ajax({
                        url: "PedidoVenda_Action.aspx/RetornarDadosItem", //URL da página com o WebMethod 
                        data: "{codItem:'" + codigo + "',tabelaPreco:'" + listaPreco + "',filial:'" + codigoFilial + "'}", //Enviar os parâmetros
                        type: "POST", //Tipo do envio (POST ou GET)
                        dataType: "json", //Tipo retorno dos dados
                        contentType: "application/json; charset=utf-8", //Conteúdo do retorno (header)
                        ...
                        success: function (retorno) {
                            if (retorno.d.length > 0) {
                                ...
                                $("#<%= txtNomeDeposito.ClientID%>").val(retorno.d[0].Item.WareHouseName.toString());

                                var descri = parseFloat(retorno.d[0].DescricaoAuxiliar).toFixed(2);
                                var compri = parseFloat(retorno.d[0].Comprimento).toFixed(0);

                                $("#<%= txtDescricaoAuxiliarItem.ClientID%>").val(descri.toString().replace(".", ","));
                                $("#<%= txtNormaItem.ClientID%>").val(retorno.d[0].Norma.toString());
                                $("#<%= txtNLoteItem.ClientID%>").val(retorno.d[0].Lote.toString());
                                $("#<%= txtComprimentoItem.ClientID%>").val(compri.toString().replace(".", ","));
                            }
                        },
                        //Função de erro do retorno dos dados feita pelo ajax
                        error: function (req, status, error) {
        ...
        $("#<%= txtQtdItem.ClientID %>").blur(function () {
         ...
         $("#<%= txtPesoEstoqueItem.ClientID %>").blur(function () {
            CalcularValoresItem();
        });
        ...
        function CalcularValoresItem() {
            ...
            var valorCampoQtdVenda = $("#<%= txtPesoEstoqueItem.ClientID %>").val();
            ...
            if (valorCampoQtdVenda != "") {
                valorCampoQtdVenda = valorCampoQtdVenda.replace('.', '');
                qtdVenda = parseFloat(valorCampoQtdVenda.replace(',', '.'));
            }
    ...
    <script type="text/javascript">
        ...
        function InserirItem() {
            ...
            var utilizacao = $("#<%= ddlUtilizacaoItem.ClientID %>").val();

            var comprimento = $("#<%= txtComprimentoItem.ClientID %>").val();
            var nrolote = $("#<%= txtNLoteItem.ClientID %>").val();
            var norma = $("#<%= txtNormaItem.ClientID %>").val();
            var qtdbarra = $("#<%= txtQtdBarraItem.ClientID %>").val();
            var qtdmetro = $("#<%= txtQtdMetrosItem.ClientID %>").val();
            var peso = $("#<%= txtPesoEstoqueItem.ClientID %>").val();
            var descricaoauxiliar = $("#<%= txtDescricaoAuxiliarItem.ClientID %>").val();

            var unidademedida = $("#<%= txtUnidadeMedida.ClientID %>").val();
            var numeropedidocompra = $("#<%= txtNumPedidoCompra.ClientID %>").val();
            var itempedidocompra = $("#<%= txtItemPedidoCompra.ClientID %>").val();

            var dataentregaitem = $("#<%= txtDataEntregaItem.ClientID %>").val();

            var descricaoItem =$("#<%= txtNomeItem.ClientID %>").val();
            ...
            if (descricaoauxiliar == "") {
                ...
                descricaoauxiliar = descricaoauxiliar.replace('.', ',');

                html += "<td>" + descricaoauxiliar + "</td>";
            }
            html += "<td>" + dataentregaitem + "</td>";
            if (comprimento == "") {
                html += "<td>0</td>";
            }
            else {
            ...
            html += "<td>0</td>";
            html += "<td>" + total + "</td>";
            html += "<td>" + numeropedidocompra + "</td>";
            html += "<td>" + itempedidocompra + "</td>";
            ...
            var novoDado = linhaTb.toString() + "|" + codigoItem + "|" + qtd + "|" + precoVenda.toString() + "|" + desconto.toString() + "|0|" + total.toString() + "|" + utilizacao + "|" + descricaoauxiliar + "|" + comprimento + "|" + nrolote + "|" + norma + "|" + qtdbarra + "|" + qtdmetro + "|" + peso + "|" + unidademedida + "|" + numeropedidocompra + "|" + itempedidocompra + "|" + dataentregaitem + "|" + descricaoItem;
            ...
            $("#<%= txtComprimentoItem.ClientID %>").val("");
            $("#<%= txtNLoteItem.ClientID %>").val("");
            $("#<%= txtNormaItem.ClientID %>").val("");
            $("#<%= txtQtdBarraItem.ClientID %>").val("");
            $("#<%= txtQtdMetrosItem.ClientID %>").val("");
            $("#<%= txtPesoEstoqueItem.ClientID %>").val("");
            $("#<%= txtDescricaoAuxiliarItem.ClientID %>").val("");
            $("#<%= txtNumPedidoCompra.ClientID %>").val("");
            $("#<%= txtItemPedidoCompra.ClientID %>").val("");
            $("#<%= txtUnidadeMedida.ClientID %>").val("");
            $("#<%= txtDataEntregaItem.ClientID %>").val("");
        }
