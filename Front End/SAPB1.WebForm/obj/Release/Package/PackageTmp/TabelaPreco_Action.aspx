<%@ Page 
    ...
    Inherits="SAPB1.WebForm.TabelaPreco_Action" 
%>
                ...
                <div class="col-md-12">
                    <asp:GridView
                        ...
                        OnPageIndexChanging="grdProdutos_PageIndexChanging">
                            <Columns>
                                <asp:TemplateField HeaderText="Cód.Tabela">
                                    <ItemTemplate>
                                        <asp:Label
                                            runat="server"
                                            ID="lblCodigoTabelaGrid"
                                            Text='<%# Eval("TabelaPreco.ListNum").ToString() %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Nome da Tabela">
                                    <ItemTemplate>
                                        <asp:Label
                                            runat="server"
                                            ID="lblNomeTabelaGrid"
                                            Text='<%# Eval("TabelaPreco.ListName").ToString() %>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:BoundField
                                    DataField="Currency"
                                    HeaderText="Moeda" />
                                <asp:TemplateField HeaderText="Preço Padrão">
                                   <ItemTemplate>
                                       <asp:Label
                                           runat="server"
                                           ID="lblPrecoPadraoGrid"
                                           Text='<%# Convert.ToDouble(Eval("Price").ToString()).ToString("n6") %>'>
                                       </asp:Label>
                                   </ItemTemplate>
                               </asp:TemplateField>
                            </Columns>
