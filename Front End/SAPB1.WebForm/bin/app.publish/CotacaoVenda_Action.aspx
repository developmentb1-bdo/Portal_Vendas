<%@ Page Title="SAP B1 - Cotação de Venda-Ação" Language="C#" MasterPageFile="~/SapB1Master.Master" AutoEventWireup="true" CodeBehind="CotacaoVenda_Action.aspx.cs" Inherits="SAPB1.WebForm.CotacaoVenda_Action" %>
...
<asp:Content ID="content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <asp:TemplateField HeaderText="UM">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblQtdGrid"
                                    Text='<%# Eval("unitMsr").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>  
                        <asp:TemplateField HeaderText="Peso Venda (KG)">
                            <ItemTemplate>
                                <asp:Label
                                    runat="server"
                                    ID="lblQtdGrid"
                                    Text='<%# Eval("U_Peso").ToString() %>'>
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>                                         
        ...
        $(function () {
            ...
            $("#<%= txtCodigoPn.ClientID %>").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $.ajax({
                        url: "CotacaoVenda_Action.aspx/RetornarDadosParceiroNegocio", //URL da página com o WebMethod 
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                ...
                if (hiddenValores != "") {
                    ...
                    for (var i = 0; i < matriz.length; i++) {
                        if (matriz[i] != "") {
                            ...
                            if (dadosItemInd.length == 12) {
                                htmlPostBack = "<tr>";
                                htmlPostBack += "<td>" + dadosItemInd[0] + "</td>";
                                htmlPostBack += "<td>" + dadosItemInd[1] + "</td>";
                                htmlPostBack += "<td>" + dadosItemInd[10] + "</td>";
                                htmlPostBack += "<td>" + dadosItemInd[11] + "</td>";
                                htmlPostBack += "<td>" + dadosItemInd[2] + "</td>";
                                htmlPostBack += "<td>0</td>";
                                htmlPostBack += "<td>" + dadosItemInd[9] + "</td>";
                                htmlPostBack += "<td>" + dadosItemInd[8] + "</td>";
            ...
            $("#<%=ddlFilial.ClientID%>").change(function () {
                ...
                $.ajax({
                    url: "CotacaoVenda_Action.aspx/RetornarDadosEmpresa", //URL da página com o WebMethod 
        ...
        $(function () {
            ...
            $("#<%= txtCodigoItem.ClientID %>").autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $.ajax({
                        url: "CotacaoVenda_Action.aspx/RetornarDadosItem", //URL da página com o WebMethod 
    ...
    <script type="text/javascript">
        ...
        function InserirItem() {
            ...
            var um = $("#<%= txtUnidadeMedida.ClientID %>").val();

            var comprimento = $("#<%= txtComprimentoItem.ClientID %>").val();
            var pecas = $("#<%= txtQtdBarraItem.ClientID %>").val();
            ...
            var novoDado = linhaTb.toString() + "|" + codigoItem + "|" + qtd + "|" + precoVenda.toString() + "|" + desconto.toString() + "|0|" + total.toString() + "|" + utilizacao + "|" + peso + "|" + um + "|" + comprimento + "|" + pecas;
        ...
        function ExcluirItem(linha) {
            ...
            for (var i = 0; i < novaMatriz.length; i++) {
                if (novaMatriz[i] != "") {
                    ...
                    html += "<td>" + dadosLinha[10] + "</td>";
                    html += "<td>" + dadosLinha[11] + "</td>";
                    html += "<td>" + dadosLinha[2] + "</td>";
                    html += "<td>0</td>";
                    html += "<td>" + dadosLinha[9] + "</td>";
                    html += "<td>" + dadosLinha[8] + "</td>";
